...
class Network():
    ...
    def init_nodes(self):
        ...
        for i, node in enumerate(self.nodes):
            node['id'] = i+1
            node['title'] = self.label_to_name(i+1)
            node['shape'] = 'image'
            # node['image'] = settings.STATIC_ROOT + f'/th_pixiv_network/images/node_{i+1}.gif'
            node['image'] = f'/static/th_pixiv_network/images/node_{i+1}.gif'
